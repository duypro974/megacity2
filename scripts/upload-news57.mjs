...
const FILES = [
  { local: "public/news57/1.jpg", publicId: "megacity2/news57/1" },
  { local: "public/news57/2.png", publicId: "megacity2/news57/2" },
  { local: "public/news57/3.png", publicId: "megacity2/news57/3" },
  { local: "public/news57/4.png", publicId: "megacity2/news57/4" },
];

async function main() {
  console.log("\n🚀 Upload ảnh news57 lên Cloudinary...\n");
  let ok = 0, fail = 0;
